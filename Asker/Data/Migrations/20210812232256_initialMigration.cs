        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventParticipationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Member_EventParticipation_EventParticipationId",
                        column: x => x.EventParticipationId,
                        principalTable: "EventParticipation",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipantsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TestingEvent_EventParticipation_ParticipantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Training_EventParticipation_ParticipantsId",
                        column: x => x.ParticipantsId,
                        principalTable: "EventParticipation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Member_EventParticipationId",
                table: "Member",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestingEvent_ParticipantsId",
                table: "TestingEvent",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Training_ParticipantsId",
                table: "Training",
                column: "ParticipantsId");
        }
